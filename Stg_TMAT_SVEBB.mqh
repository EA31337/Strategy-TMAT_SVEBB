...
INPUT int TMAT_SVEBB_SignalOpenFilterTime = 8;     // Signal open filter time
...
INPUT int TMAT_SVEBB_TickFilterMethod = -48;       // Tick filter method
...
struct Stg_TMAT_SVEBB_Indi_TMA_True_Params_Defaults : Indi_TMA_True_Params {
  Stg_TMAT_SVEBB_Indi_TMA_True_Params_Defaults()
