...
struct Indi_TMA_True_Params_M15 : Indi_TMA_True_Params {
  Indi_TMA_True_Params_M15() : Indi_TMA_True_Params(stg_tmat_svebb_indi_tmat_defaults, PERIOD_M15) { shift = 0; }
} indi_tmat_m15;

// Defines strategy's parameter values for the given pair symbol and timeframe.
struct Stg_TMAT_SVEBB_EURUSD_M15_Params : Stg_TMAT_SVEBB_Params {
  Stg_TMAT_SVEBB_EURUSD_M15_Params() {
