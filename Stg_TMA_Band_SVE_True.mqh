...
struct Stg_TMA_Band_SVE_True_Params : StgParams {
  ...
  Stg_TMA_Band_SVE_True_Params(Trade *_trade = NULL, Indicator *_data = NULL, Strategy *_sl = NULL, Strategy *_tp = NULL)
...
class Stg_TMA_Band_SVE_True : public Strategy {
 public:
  ...
  static Stg_TMA_Band_SVE_True *Init(ENUM_TIMEFRAMES _tf = NULL, long _magic_no = NULL, ENUM_LOG_LEVEL _log_level = V_INFO) {
